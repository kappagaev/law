...
class RequestController extends Controller
{
    ...
    public function store(RequestStoreRequest $request, RequestService $service, RequestMailService $requestMailService)
    {
        ...
        return redirect('/')->with('message', 'Дякуємо, ваше повідомлення прийнято. Після перевірки його буде розміщено на сайті та направено на адресу Уповановаженого із захисту держаної мови.');
    }
