...
{{--        </div>--}}
        ...
        <hr>
        <div class="mb-3">
            Дані потрібні щоб верифікувати користувачів та формувати текст звертання до Уповноваженого із захитсу державної мови, який відповідатиме вимогам законодавства
        </div>
